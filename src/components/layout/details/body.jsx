...
function BodyDetails({ item, char, reviews, stat, video }) {
  ...
  return (
    <div className="flex w-full relative px-2 flex-col ">
              ...
              <div
                ...
                className={`flex gap-2 items-center ${
                  active == index
                    ...
                    : "text-white opacity-50 relative "
                } flex-col transision-all h-[30px] hover:text-yellow-500 hover:opacity-100 cursor-pointer relative duration-300 overflow-visible`}
              >
                ...
                <div
                  className={`w-full h-[2px] ${
                    active == index ? "bg-yellow-500 opacity-100" : ""
                  }  absolute bottom-[-8px] transition-all duration-300 ease-in-out`}
                ></div>
              </div>
            </>
          );
            ...
            return (
              <SwiperSlide key={index} className="relative">
                <div
                  ...
                  className={`flex gap-2 items-center ${
                    active == index
                      ? "text-yellow-500 opacity-100"
                      : "text-white opacity-50 relative "
                  } flex-col transision-all h-[30px] cursor-pointer relative duration-300 overflow-visible`}
                >
                ...
                <div
                  className={`w-full h-[2px] ${
                    active == index ? "bg-yellow-500 opacity-100" : ""
                  }  absolute bottom-[-2px] transition-all duration-300 ease-in-out`}
                ></div>
              </SwiperSlide>
            );
          })}
      ...
      <div className="w-full mt-2">{page[active].content}</div>
    </div>
  );
}
